Ext.define('AM.view.sales.deliverylostentry.Form', {
  extend: 'Ext.window.Window',
  alias : 'widget.deliverylostentryform',
  ...
  initComponent: function() {
    ...
    this.items = [{
      ...
      items: [
				...
				{
					xtype: 'displayfield',
					fieldLabel: 'Delivery Lost',
					name: 'delivery_lost_code',
					value: '10'
				},
				{
					fieldLabel: 'Item',
	...
	setParentData: function( record ){
		this.down('form').getForm().findField('delivery_lost_code').setValue(record.get('code')); 
	},
